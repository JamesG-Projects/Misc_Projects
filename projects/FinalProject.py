...
################################################################################
# Player-Enemy Combat & Interaction ############################################
################################################################################
    ...
    def fight(self, person):
        ...
        if EName in 'Computer':
            ...
            if keyboard in self.backpack:
                ...
                #itemsPlayer.update(keyboard = randint(1,5))                    #This also works
        ...
        while play:
            ...
            while (self.health != 0 or enemy.health != 0):
                ...
                heal = False                                                    #Give back some missing health
            ...
            if winner == self.name:
                ...
                if enemy.name == 'Computer':
                    ...
                    if check_win_state(self):
                        ...
                        print('There\'s more exploring to do.')
...
################################################################################
    ...
    def take(self, thing):
        ...
        if type(thing) != str:                                                  #If it's not the right format
            ...
            if taken is 0:                                                      #0 = item isn't at the place
                ...
                self.tookbackpack = True                                        #Then we now have a backpack
                ...
                print('You don\'t have anything to carry it in!')
            elif tookbackpack(self) is True:                                    #If we already have a backpack
                print(self.name, 'takes the', taken.name)
                self.backpack.append(taken)
            else:
    ...
    def check_backpack(self):
        for item in self.backpack:
            if item is backpack:                                                #If backpack item is inside backpack item
                del self.backpack[item]                                         #Delete backpack from inside backpack
        ...
        if tookbackpack(self):                                                  #If we have a backpack
            if len(self.backpack) is 0:                                         #If backpack is empty
                ...
                for item in self.backpack:                                      #Iterate through backpack and print out item names
    ...
    def take(self, thing):
        if thing not in self.things:
            if Player.tookbackpack is False:
                ...
                #print(thing, 'is not here.')                                   #Catch if thing isn't in the place
                return 0
            ...
            if not Player.tookbackpack:                                         #If we haven't picked up the backpack yet
                return 0
            else:
...
################################################################################
# Command Parsing and Evaluation ###############################################
################################################################################
...
################################################################################
# Help Message / Check Win State / More Backpack Mechanics #####################
################################################################################
...
def read_eval_print_loop():
    ...
    while True:
        ...
        except SyntaxError as e:                                                #Syntax Errors
            print('ERROR:', e)


################################################################################
# Game Commands and Config #####################################################
################################################################################
